<template>
      ...
      <div class="bg-zinc-50 dark:bg-black min-h-screen">
        <div class="container mx-auto px-4 py-8">
          ...
          <div class="flex justify-between items-center mb-6">
            ...
            <!-- Use EditTeam component here for Edit Team functionality -->
            <div v-if="canEditTeam">
              <EditTeam /> <!-- Replace Button with EditTeam component -->
            </div>
          </div>
  ...
  import { EditTeam } from '@/components/custom/edit-team/EditTeam.vue';
  import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
  import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
  import { Search, PencilIcon } from "lucide-vue-next";
